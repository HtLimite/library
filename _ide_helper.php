 ...
 * Generated for Laravel 5.8.38 on 2022-06-14 09:00:34.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Request {
        ...
        /**
         * Get a segment from the URI (1 based css).
         *
         * @param int $index
         ...
         *
         * Suppose that an css.php file instantiates this request object:
         *
         ...
         * script filename (e.g. css.php) if one exists.
         *
