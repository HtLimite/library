        ...
        <div class="login sign-up-htm">
            <form onsubmit="return false" class="container offset1 loginform" id="Regform">
                ...
                <div class="pad input-container">
                    <section class="content">
						<span class="input input--hideo">
							<input name="account" class="input__field input__field--hideo" type="text" id="register-username"
                        ...
                        <span class="input input--hideo">
								<input name="repass" class="input__field input__field--hideo" type="password" id="register-repassword" placeholder="请确认密码" maxlength="15"/>
